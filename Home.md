...
# Overview
This project was built using docker. For help regarthing docker please visit [docker docs](https://docs.docker.com/).
## Structure
...
Even though the wrapper scripts are not truly required they are highly recommended.   
